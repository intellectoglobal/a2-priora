...
class NewCourse(models.Model):
    ...
    course_addded_date = models.DateField(
        db_column='course_added_date', auto_now_add=True, blank=False)
    ...
    duration = models.CharField(
        db_column='duration', max_length=20, choices=duration, blank=False)
    day_period = models.CharField(
        db_column='day_period', max_length=20, choices=day_period, blank=False)
    certificate_code = models.CharField(
        db_column='certificate_code', max_length=50, blank=False)
